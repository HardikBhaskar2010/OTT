  ...
  return (
    ...
    >
      ...
      >
        ...
        <section id="introduction" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
        ...
        <section id="collection" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('2. Information We Collect', '2. एकत्रित जानकारी')}
          </h2>
          ...
          <ul style={{ color: 'var(--color-text-dim)', paddingLeft: '20px', lineHeight: 1.6 }}>
        ...
        <section id="usage" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('3. How We Use Your Information', '3. जानकारी का उपयोग')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
        ...
        <section id="sharing" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('4. Sharing & Disclosure', '4. साझाकरण और प्रकटीकरण')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
        ...
        <section id="dpdp" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('5. Your DPDP Rights (India)', '5. आपके डीपीडीपी अधिकार')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)', marginBottom: '10px' }}>
            {t(
        ...
        <section id="security" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('6. Data Security', '6. डेटा सुरक्षा')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
        ...
        <section id="contact" style={{ scrollMarginTop: '100px' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('7. Grievance Officer', '7. शिकायत अधिकारी')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
