  ...
  return (
    ...
    >
      ...
      >
        ...
        <section id="overview" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('1. DPDP Overview', '1. डीपीडीपी सिंहावलोकन')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
              'Under the Digital Personal Data Protection Act, 2023 ("DPDP Act") of India, CultureFlix (operated by Sunad Broadcast Pvt. Ltd.) acts as a Data Fiduciary. This notice outlines your rights as a Data Principal regarding the digital processing of your personal data by our platform.',
        ...
        <section id="consent" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('2. Consent Framework', '2. सहमति ढांचा')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)', marginBottom: '10px' }}>
            {t(
        ...
        <section id="principals" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('3. Data Principal Rights', '3. डेटा प्रिंसिपल के अधिकार')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)', marginBottom: '10px' }}>
            {t(
        ...
        <section id="officer" style={{ scrollMarginTop: '100px', marginBottom: 'var(--space-6)' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('4. Data Protection Officer', '4. डेटा संरक्षण अधिकारी')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
        ...
        <section id="disputes" style={{ scrollMarginTop: '100px' }}>
          <h2 className="type-heading-2" style={{ color: 'var(--primitive-white)', borderLeft: '3px solid var(--color-gold)', paddingLeft: '12px', marginBottom: '14px' }}>
            {t('5. Grievance Redressal & Board', '5. शिकायत निवारण और बोर्ड')}
          </h2>
          <p style={{ lineHeight: 1.6, color: 'var(--color-text-dim)' }}>
            {t(
